...
The source code, defense implementations, evaluation scripts, and experimental results supporting this study are publicly available at \url{https://github.com/Zoro621/financial-rag-defense}. The knowledge base was constructed from the publicly available RBC AI Banking Agent corpus (\url{https://github.com/frogcoder/llm-chatbot}). Adversarial prompts were obtained from JailbreakBench \cite{chao2024jailbreakbench} (\url{https://github.com/JailbreakBench/jailbreakbench}). Benign financial queries were drawn from the FinGPT FiQA-QA dataset (\url{https://huggingface.co/datasets/FinGPT/fingpt-fiqa_qa}) and FinQA (\url{https://github.com/czyssrs/FinQA}).
